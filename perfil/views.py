...
def home(request):
    ...
    return render(request, 'home.html', {'contas': contas, 
                                         ...
                                         'percentual_gastos_essenciais': int(percentual_gastos_nao_essenciais),
                                         })
...
def cadastrar_banco(request):
    ...
    if len(apelido.strip()) == 0 or len(valor.strip()) == 0:
        messages.add_message(request, constants.ERROR, 'Preencha o Apelido Corretamente')
    ...
    messages.add_message(request, constants.SUCCESS, 'Conta Cadastrada Corretamente')
    return redirect('/perfil/gerenciar/')
